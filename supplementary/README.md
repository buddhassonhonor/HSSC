...
- `supplementary/S3_policy_documents_index.csv`: index template for policy documents and authoritative interpretations used in the analysis (to be completed with exact titles/URLs and access dates).
- `supplementary/S4_public_narratives_index.csv`: index template for public reform narratives (media reports/speeches/discourse) used for semiotic coding (to be completed).
